...
You can upgrade in a few steps:
  ...
  Make sure you read through the ["what's new in 2.7" document](https://docs.bigbluebutton.org/2.7/new-features) and specifically [the section covering notable changes](https://docs.bigbluebutton.org/2.7/new-features#other-notable-changes)
